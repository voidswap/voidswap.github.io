$(document).ready(function () {
    ...
    for (var i = 0; i < share_bar.length; i++) {
        var html = '<iframe allowtransparency="true" frameborder="0" scrolling="no"' +
            'src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + '&amp;text=' + encodeURIComponent(document.title) + '&amp;via=swapnil&amp;hashtags=swapnilandvarsha&amp;count=horizontal"' +
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Swapnil and Varsha's Wedding",

            // Event start date
            start: new Date('Dec 09, 2024 10:00'),
            ...
            end: new Date('Dec 09, 2024 00:00'),

            // Event Address
            address: 'Royal Orchid, Indore',
